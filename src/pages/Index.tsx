...
const Index = () => {
  ...
  // Show role selector if wallet is connected but no role is selected
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {userRole === 'freelancer' && <FreelancerDashboard userAddress={address} />}
          {userRole === 'arbitrator' && <ArbitratorDashboard userAddress={address} />}
        </div>
      </div>
    );
  }
